...
Route::group(["prefix" => "api/webshop"], function() {
    ...
    Route::group(["middleware" => config("webshop.routing.middleware.auth")], function() {
        ...
        Route::group(["prefix" => "products"], function() {
            ...
            // Setters
            Route::group(["middleware" => config("webshop.routing.middleware.products")], function() {
        ...
        Route::group(["prefix" => "orders"], function() {
            ...
            // Setters
            Route::group(["middleware" => config("webshop.routing.middleware.orders")], function() {
